 ...
 * @param {Object} props.item - The template object containing details about the template.
 * @param {string|number} props.item.id - The unique identifier for the template.
 ...
 *
 * <TitleNavButton item="{item}" label="{label}" segment="{segment}"/>
 * // Resulting URL: `/ug/template/view/123#details`
 *
 * @example
 * // Example 2: Different segment and label
 * <TitleNavButton 456 id: item="{{" label="Template Settings" segment="settings" }}/>
 ...
 * if an `item` object is provided.
 *
 * @component
 * @param {Object} props - The component properties.
 * @param {Object} props.item - The template entity object that provides context for the page.
 * @param {string|number} props.item.id - The unique identifier for the template.
 * @param {ReactNode} [props.children] - Obsah stránky (vnořené komponenty).
 ...
 * // Example usage:
 * const item = { id: 123, ... };
 * <PageNavbar item="{item}" onSearchChange="{handleSearchChange}"/>
 */
...
//                         <TitleNavButton ""} "active" "page" // : ? aria-current="{segment" className="{segment" currentHash item="{item}" label="{label}" segment="{segment}" undefined}/>
//                     </Nav.Item>
//                 ))}
//                 {children}
//             </MyNavbar>
